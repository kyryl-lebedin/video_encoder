...
int main(int argc, char *argv[]){
    ...
    if (function == "reverse") {
        ...
        cout << "Time taken for reverse function: " << elapsed.count() << " seconds" << endl;
    }
        ...
        auto end = chrono::high_resolution_clock::now();
        chrono::duration<double> elapsed = end - start;
        cout << "Time taken for swap_channels: " << elapsed.count() << " seconds" << endl;
    }
        ...
        // if (stream.fail() || comma != ',' || tempMin < 0 || tempMax < 0 || tempMin > 128 || tempMax > 128) {
        //     throw std::runtime_error("Invalid input. The range to clip pixels is 0-128.");
        // }
        ...
        auto start = chrono::high_resolution_clock::now();
        clip_channel(input, output, mode, static_cast<unsigned char>(stoi(options[0])), min, max);
        auto end = chrono::high_resolution_clock::now();
        chrono::duration<double> elapsed = end - start;
        cout << "Time taken for clip_channel: " << elapsed.count() << " seconds" << endl;
        ...
        auto end = chrono::high_resolution_clock::now();
        chrono::duration<double> elapsed = end - start;
        cout << "Time taken for scale_channel: " << elapsed.count() << " seconds" << endl;
