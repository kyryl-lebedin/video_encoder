...
bool swap_channel(const string& input, const string& output, const string& mode,
  ...
  if (mode == "-S") {
    ...
    // size_t frameSize = static_cast<size_t>(channels) * channelSize;
    ...
    //     if (j == static_cast<size_t>(channel1) - 1) {
    //       swappedVideo.write(frameBuffer.data() + channelSize * (channel2 -
    //       1),
    //                          channelSize);
    //     } else if (j == static_cast<size_t>(channel2) - 1) {
    //       swappedVideo.write(frameBuffer.data() + channelSize * (channel1 -
    //       1),
    //                          channelSize);
    //     } else {
    //       swappedVideo.write(frameBuffer.data() + channelSize * j,
    //       channelSize);
    //     }
    //   }
    // }
